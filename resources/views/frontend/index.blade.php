...
<div class="container">
    ...
    <div class="themesbazar_led_active owl-carousel owl-loaded owl-drag">
      @php
          $top_slider = App\Models\NewsPost::where('status', 1)->where('top_slider', 1)->limit(3)->get();
      @endphp
            ...
            <div class="owl-item cloned" style="width: 506.25px; margin-right: 20px;">
              <div class="secOne_newsContent">
                  <div class="sec-one-image">
                    <a href=" "><img class="lazyload" src="{{ asset($slider->image) }}"></a>
    ...
    <div class="col-lg-5 col-md-5">
      ...
      @endphp
      @foreach ($section_three as $sec_3)
          <div class="secOne-smallItem">
            <div class="secOne-smallImg">
            <a href=" "><img class="lazyload" src="{{ asset($sec_3->image) }}"  ></a>
            <h5 class="secOne_smallTitle">
            <a href="{{ url('news/details/'.$sec_3->id.'/'.$sec_3->news_title_slug) }}">{{ $sec_3->news_title }}</a>
            </h5>
            </div>
            </div>
      @endforeach
    ...
    <div class="row">
      ...
      @php
          $section_nine = App\Models\NewsPost::where('status', 1)->where('first_section_nine', 1)->limit(7)->get();
      @endphp
      @foreach ($section_nine as $sec_9)
          <div class="themesBazar-3 themesBazar-m2">
            <div class="sec-one-wrpp2">
            <div class="secOne-news">
            <div class="secOne-image2">
            <a href=" "><img class="lazyload" src="{{ asset($sec_9->image) }}"  ></a>
            </div>
            <h4 class="secOne-title2">
            <a href="{{ url('news/details/'.$sec_9->id.'/'.$sec_9->news_title_slug) }}">{{ $sec_9->news_title }}</a>
            </h4>
            </div>
            <div class="cat-meta">
            <a href=" "> <i class="lar la-newspaper"></i>
              {{ $sec_9->updated_at->format('d M Y') }}
            </a>
            </div>
            </div>
            </div>
    ...
    <div class="news-titletab">
          ...
          @foreach ($newnewspost as $nitem)
            <div class="tab-image tab-border">
              <a href="{{ url('news/details/'.$nitem->id.'/'.$nitem->news_title_slug) }}"><img class="lazyload" src="{{ asset($nitem->image) }}"  ></a>
              <a href=" " class="tab-icon"><i class="la la-play"></i></a>
              <h4 class="tab_hadding"><a href="{{ url('news/details/'.$nitem->id.'/'.$nitem->news_title_slug) }}">{{ $nitem->news_title }}</a></h4>
              </div>
          @endforeach
