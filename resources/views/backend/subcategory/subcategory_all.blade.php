                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('add.subcategory') }}" class="btn btn-blue waves-effect waves-light">Add Sub Category</a>
                        </ol>
                    </div>
                    <h4 class="page-title">Sub Category All</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($get_subcategories as $key => $item)
                                    <tr>
                                        <td>{{ $key+1 }}</td>
