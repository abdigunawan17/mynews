                    ...
                    <div class="card-body">
                        ...
                        <form id="myForm" method="post" action="{{ route('update.news.post') }}" enctype="multipart/form-data">
                                   ...
                                   <select name="subcategory_id" id="" class="form-select">
                                        ...
                                        @else
                                            ...
                                            @foreach ($subcategories as $subcategory)
                                                <option value="{{ $subcategory->id }}" {{ $subcategory->id == $newspost->subcategory_id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3 form-group col-lg-6">
                                   ...
                                   <select name="user_id" id="" class="form-select">
                                        ...
                                        @foreach ($adminuser as $user)
                                            <option value="{{ $user->id }}" {{ $user->id == $newspost->user_id ? 'selected' : '' }}>
                                                {{ $user->name }}
                                            </option>
                                        @endforeach
                                   </select>
                            ...
                            <div class="mb-3 form-group col-lg-6">
                                ...
                                <input type="text" name="news_title" class="form-control" value="{{ $newspost->news_title }}" id="inputAddress">
                            </div>
                            ...
                            <div class="mb-3 form-group col-lg-6">
                                ...
                                <img id="show_image" src="{{ asset($newspost->image) }}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-check mb-2 form-check-warning">
                                        <input class="form-check-input" type="checkbox" name="first_section_three" value="1" id="customckeck3" {{ $newspost->first_section_three == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="customckeck3">First Section Three</label>
                                    </div>

                                    <div class="form-check mb-2 form-check-blue">
                                        <input class="form-check-input" type="checkbox" name="first_section_nine" value="1" id="customckeck4" {{ $newspost->first_section_nine == 1 ? 'checked' : '' }}>
